...
class CdcPartitionReader<T : Comparable<T>>(
    ...
    override fun tryAcquireResources(): PartitionReader.TryAcquireResourcesStatus {
        ...
        stateFilesAccessor = DebeziumStateFilesAccessor()
    ...
    enum class CloseReason(val message: String) {
        SYNTHETIC("processed a synthetic initial state"),
        TIMEOUT("timed out"),
    ...
    companion object {
         ...
         */
        internal fun getSourceRecord(event: ChangeEvent<String?, String?>): SourceRecord? {
            ...
            return f[event] as? SourceRecord
        }
